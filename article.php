                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="article-detail.php?id=<?= $pws['id']; ?>" class="btn btn-sm btn-secondary"><i class="fas fa-portrait fa-fw"></i> Detail</a>
                                        <a href="article-edit.php?id=<?= $pws['id']; ?>" class="btn btn-sm btn-warning"><i class="fas fa-pen fa-fw"></i> Edit</a>
