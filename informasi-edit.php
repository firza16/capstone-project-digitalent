...
<head>
    ...
    <title>Paket Wisata Tambah - Desa Wisata</title>
</head>
...
<body>
    ...
    include 'koneksi.php';
    $id = $_GET['id'];
    $informasi = mysqli_query($koneksi, "SELECT * FROM informasi WHERE id='$id'");
    $pws = mysqli_fetch_assoc($informasi);
    ?>
    ...
    <div class="col-md-8 mx-auto py-5">
        <div class="card shadow">
            ...
            <div class="card-body">
                <form action="informasi-edit-proses.php" method="post" enctype="multipart/form-data">
                <input type="hidden" name="id" id="id" value="<?= $pws['id']; ?>" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" id="tanggal" name="tanggal" value="<?= $pws['tanggal']; ?>" placeholder="Masukkan tanggal" required>
                    </div>
