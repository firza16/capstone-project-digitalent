...
<body>
    ...
    <div class="col-md-8 mx-auto py-5">
        <div class="card shadow">
            ...
            <div class="card-body">
                <form action="article-tambah-proses.php" method="post" enctype="multipart/form-data">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="author" name="author" placeholder="Masukkan author" required>
                    </div>
